<%@ Page Language="VB" AutoEventWireup="false" CodeFile="customerMenu.aspx.vb" Inherits="customerMenu" %>
...
<body>
    ...
    <div style="height: 505px">
        ...
        <asp:Label ID="Label1" runat="server" Text="Customer Menu: "></asp:Label>
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Search Books" />
        <br />
        <br />
        <br />
